#!/usr/bin/env python3
"""Windows SLCAN example for the MeatPi USB CAN firmware.

Install:
    pip install python-can pyserial

Example:
    python windows_slcan_example.py --port COM3 --bitrate 500000 --can-id 0x123 --data 11223344
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Send one CAN frame over a Windows SLCAN COM port.")
